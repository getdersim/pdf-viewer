...
var DEFAULT_URL = window.location.search.slice(5) || '../compressed.tracemonkey-pldi-09.pdf';
...
var PDFViewerApplication = {
  ...
  setTitle: function pdfViewSetTitle(title) {
    document.title = 'Ders.im';
    // document.getElementById('title').textContent = 'Ders.im';
  },
